jQuery(document).ready(function ($) {
  ...
  if ($("#responsive-menu-button-sub").length) {
    $("#responsive-menu-button-sub").sidr({
      name: "sidr-main",
      source: "#navigation-sub",
      mbind: " click",
    });
  }
  ...
  if ($(".edu_masonery_thumb a[data-rel^='prettyPhoto']").length) {
    $(".edu_masonery_thumb:first a[data-rel^='prettyPhoto']").prettyPhoto({
